...
export const projects = [
  ...
  },
  {
    ...
    description: 'An event-driven trading system for the TSX. It runs a long-only volatility breakout strategy on a Rust execution core, with a React dashboard on top.',
  ...
  },
  {
    ...
    description: 'Ingests U.S. House, Senate and SEC Form 4 disclosures, scores the trades they reveal, and backtests them against the market.',
  ...
  },
  {
    ...
    description: 'A Python pipeline that turns high-resolution vinyl rips into archival packages, each one checksummed so it can be proven unaltered later.',
  ...
  },
  {
    ...
    description: 'A Windows app that pulls audio off Blu-ray, DVD and SACD discs, hashing the source and the result so every extraction can be audited.',
  ...
  },
  {
    ...
    description: 'A Windows desktop suite for GPU fan, power and clock control. Every change goes through a signed driver, and any failed change rolls back.',
